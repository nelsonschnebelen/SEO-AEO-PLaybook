...
const GMB_CHECKS = [
  {
    id: 'status', todo: "Set your listing back to open", doIn: 'google', mins: 10, sev: 'critical', label: 'Listing is marked open',
  ...
  {
    id: 'hours', todo: "Add your opening hours", doIn: 'google', mins: 15, sev: 'critical', label: 'Opening hours are published',
  ...
  {
    id: 'phone', todo: "Add your phone number", doIn: 'google', mins: 2, sev: 'critical', label: 'Phone number is listed',
  ...
  {
    id: 'website', todo: "Add your website link", doIn: 'google', mins: 2, sev: 'critical', label: 'Website link is set',
  ...
  {
    id: 'website-match', todo: "Point your profile at your own site", doIn: 'google', mins: 3, sev: 'critical', label: 'Website link points at your own site',
  ...
  {
    id: 'rating', todo: "Lift your rating", doIn: 'ops', mins: 0, sev: 'important', label: 'Rating is competitive',
  ...
  {
    id: 'review-volume', todo: "Get more reviews coming in", doIn: 'ops', mins: 0, sev: 'important', label: 'Enough reviews to compete',
  ...
  {
    id: 'review-recency', todo: "Get the review flow going again", doIn: 'ops', mins: 0, sev: 'important', label: 'Reviews are still arriving',
  ...
  {
    id: 'photos', todo: "Add more photos", doIn: 'google', mins: 30, sev: 'important', label: 'Enough photos on the profile',
  ...
  {
    id: 'category', todo: "Pick a more specific category", doIn: 'google', mins: 3, sev: 'important', label: 'Category is specific',
  ...
  {
    id: 'price', todo: "Set your price range", doIn: 'google', mins: 2, sev: 'important', label: 'Price level is set',
  ...
  {
    id: 'accessibility', todo: "Tick your accessibility options", doIn: 'google', mins: 5, sev: 'important', label: 'Accessibility is declared',
  ...
  {
    id: 'dietary', todo: "Declare your dietary options", doIn: 'google', mins: 3, sev: 'important', label: 'Dietary options are declared',
  ...
  {
    id: 'service-options', todo: "Tick dine-in, takeout and delivery", doIn: 'google', mins: 3, sev: 'nice', label: 'Service options are complete',
  ...
  {
    id: 'reservable', todo: "Say whether you take reservations", doIn: 'google', mins: 2, sev: 'nice', label: 'Reservation status is declared',
  ...
  {
    id: 'summary', todo: "Write your profile description", doIn: 'google', mins: 15, sev: 'nice', label: 'Profile description is written',
  ...
  {
    id: 'amenities', todo: "Fill in your amenities", doIn: 'google', mins: 10, sev: 'nice', label: 'Amenities are filled in',
  ...
  {
    id: 'meals', todo: "Say which meals you serve", doIn: 'google', mins: 3, sev: 'nice', label: 'Meal services are declared',
...
function analyzeGmb(place, ctx) {
  ...
  GMB_CHECKS.forEach(c => {
    ...
    if (detail) findings.push({ sev: c.sev, title: c.todo || c.label, detail, fix: c.fix, why: c.why,
                               doIn: c.doIn, mins: c.mins, source: 'gmb' });
