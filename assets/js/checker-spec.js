...
const RESTAURANT_FIELDS = [
  {
    doIn: 'code', mins: 15, k: 'name', sev: 'critical', label: 'Business name',
  ...
  {
    doIn: 'code', mins: 15, k: 'address', sev: 'critical', label: 'Postal address', obj: 'PostalAddress',
  ...
  {
    doIn: 'code', mins: 15, k: 'telephone', sev: 'critical', label: 'Phone number',
  ...
  {
    doIn: 'code', mins: 15, k: 'url', sev: 'critical', label: 'Website URL',
  ...
  {
    doIn: 'code', mins: 15, k: 'openingHoursSpecification', sev: 'important', label: 'Opening hours',
  ...
  {
    doIn: 'code', mins: 15, k: 'servesCuisine', sev: 'important', label: 'Cuisine',
  ...
  {
    doIn: 'code', mins: 15, k: 'priceRange', sev: 'important', label: 'Price range',
  ...
  {
    doIn: 'code', mins: 15, k: 'image', sev: 'important', label: 'Image',
  ...
  {
    doIn: 'code', mins: 15, topic: 'menu-pdf', k: 'hasMenu', sev: 'important', label: 'Menu',
  ...
  {
    doIn: 'code', mins: 15, k: 'geo', sev: 'important', label: 'Coordinates',
  ...
  {
    doIn: 'code', mins: 15, k: 'acceptsReservations', sev: 'nice', label: 'Reservations',
  ...
  {
    doIn: 'code', mins: 15, k: 'sameAs', sev: 'nice', label: 'Linked profiles (sameAs)',
  ...
  {
    doIn: 'code', mins: 15, k: 'description', sev: 'nice', label: 'Description',
  ...
  {
    doIn: 'code', mins: 15, k: 'paymentAccepted', sev: 'nice', label: 'Payment methods',
...
const PAGE_CHECKS = [
  {
    id: 'title', todo: "Write a real page title", doIn: 'site', mins: 5, sev: 'critical', label: 'Title tag',
  ...
  {
    id: 'jsonld', todo: "Add structured data", topic: 'no-schema', doIn: 'code', mins: 20, sev: 'critical', label: 'Structured data present',
